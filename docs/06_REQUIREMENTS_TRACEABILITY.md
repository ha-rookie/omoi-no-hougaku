...
| REQ-013 | PWAインストール導線 | APP §11, UI-005 | ADR-0004 | #69 | `public/index.html`, `public/app.js`, `public/js/infrastructure/pwa-install.js`, `public/manifest.webmanifest` | `pwa-install.test.mjs` + Android Chrome実機 | ACTIVE |
